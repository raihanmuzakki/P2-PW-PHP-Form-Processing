...
<h5 class="text-right">Dinyatakan : <?= $pernyataan; ?></h5>
<h5 class="text-center py-3 mt-5" style="background-color: #5eff89;">Proses: <?= $_proses?></h5>
</div>
</body>
</html>